...
public class HSqlDbExecute<T> extends SQLExecute<T> {

	@SuppressWarnings("unused")
	private static final Logger log = LoggerFactory.getLogger(HSqlDbExecute.class);
	private int maxSize = -1;
	
	public HSqlDbExecute(int maxSize) {
